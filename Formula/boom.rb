...
class Boom < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d0fcf47cf1cb4ae1b0c24234076b3656057b805a4ad93db3a64409a0a3a232ac"
    end
    on_intel do
      url "https://github.com/alxjrvs/boom/releases/download/v#{version}/boom-bun-darwin-x64"
      sha256 "828e71425d0fe8a55ffb87fb35969fdb4ffb2677dc2beecdfdf5fe080bc7f3a0"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "0722aa20dc35daf3be2759dc46a486d5d4c078030c923f5cae7e282b793eb596"
    end
    on_intel do
      url "https://github.com/alxjrvs/boom/releases/download/v#{version}/boom-bun-linux-x64"
      sha256 "1029514635ed50871dff01d0aea20c282a7627296a7e4b26bb40cb2828fd3a57"
    end
  end
