...
${head({
    title: "Guide — boom",
    desc: "How to use boom: install, bootstrap a machine, the reconcile loop (sync / verify / repair, and rollback), the boomfile.toml reference, config-repo git, code portals, and housekeeping.",
    slug: "guide",
  })}
</head>
<body>
